    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('super_admin', 'Super Admin'), ('admin', 'Admin'), ('employer', 'Employer'), ('job_seeker', 'Job Seeker')], max_length=50, unique=True, verbose_name='Role Name')),
